...
_ROUTES: Dict[Tier, Dict[Purpose, ModelChoice]] = {
    ...
    "pro": {
        "interview":           ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "photoAnalysis":       ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "compatibilityFilter": ModelChoice("google",    "gemini-2.5-flash",           "Gemini Flash"),
        "proxyTurn":           ModelChoice("google",    "gemini-2.5-flash",           "Gemini Flash"),
        "score":               ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "prescreen":           ModelChoice("google",    "gemini-2.5-flash",           "Gemini Flash"),
        "intake":              ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "mediation":           ModelChoice("google",    "gemini-2.5-flash",           "Gemini Flash"),
        "takeaway":            ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
    },
    "x": {
        "interview":           ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "photoAnalysis":       ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "compatibilityFilter": ModelChoice("anthropic", "claude-haiku-4-5-20251001",  "Claude Haiku"),
        "proxyTurn":           ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "score":               ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "prescreen":           ModelChoice("anthropic", "claude-haiku-4-5-20251001",  "Claude Haiku"),
        "intake":              ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "mediation":           ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
        "takeaway":            ModelChoice("anthropic", "claude-sonnet-4-5-20250929", "Claude Sonnet"),
    },
}
